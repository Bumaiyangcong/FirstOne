package com.bumaiyangcong.fragmentbestpractice;
...
import com.bumaiyangcong.fragmenrbestpractice.R;
...
/**
 * Created by pange on 公元17-06-12.
 */
...
public class NewsTitleFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (getActivity().findViewById(R.id.news_content_layout) != null) {
            ...
            isTwoPane = false;//没找到找到news_content_layout布局时为单叶模式
        }
    }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isTwoPane) {
                        //如果是双叶模式则刷新NewsContentActivity中内容
