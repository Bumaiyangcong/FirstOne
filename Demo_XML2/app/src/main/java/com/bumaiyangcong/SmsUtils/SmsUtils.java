...
public class SmsUtils {
    ...
    public static boolean backupSms(Context context) {
        ...
        try {
            openFileOutput = context.openFileOutput("backupsms.xml", Context.MODE_PRIVATE);
            ...
            while (type != XmlPullParser.END_DOCUMENT) {
                ...
                switch (type) {
                    case XmlPullParser.START_TAG:
                        ...
                        } else if (currentTagName.equals("number")) {
                            smsBean.number = xpp.nextText();
